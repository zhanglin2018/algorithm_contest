...
public class ImprovedBC3_2 {
	...
	public static void bin_completion(List<Bin> bin_list, DescendingSortedList items, int waste) {
		...
		Integer largest_item = items.max();
	...
	public static void generate_completions(List<Bin> completions, Bin current_bin, List<Integer> excludes,
			DescendingSortedList remain_items, int lower_bound, int upper_bound) {
